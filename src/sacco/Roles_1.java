...
@NamedQueries({
    ...
    , @NamedQuery(name = "Roles_1.findByRole", query = "SELECT r FROM Roles_1 r WHERE r.role = :role")
    , @NamedQuery(name = "Roles_1.findBySalary", query = "SELECT r FROM Roles_1 r WHERE r.salary = :salary")})
public class Roles_1 implements Serializable {
    ...
    public Roles_1(Integer id, String role, String salary) {
        this.id = id;
        this.role = role;
        this.salary = salary;
    }
