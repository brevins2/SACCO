...
@NamedQueries({
    ...
    , @NamedQuery(name = "Customer_1.findByDiscountCode", query = "SELECT c FROM Customer_1 c WHERE c.discountCode = :discountCode")
    , @NamedQuery(name = "Customer_1.findByZip", query = "SELECT c FROM Customer_1 c WHERE c.zip = :zip")
...
public class Customer_1 implements Serializable {
    ...
    public Customer_1(Integer customerId, Character discountCode, String zip) {
        this.customerId = customerId;
    ...
    public String toString() {
        return "sacco.Customer_1[ customerId=" + customerId + " ]";
    }
